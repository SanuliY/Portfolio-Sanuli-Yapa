        ...
        {prev ? (
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 text-muted-foreground group-hover:text-foreground transition-colors">
                ...
                <span className="text-sm font-bold tracking-wide uppercase">Previous Project</span>
              </div>
              <div>
                <h3 className="text-2xl md:text-3xl font-bold tracking-wide text-foreground">
                  {prev.title}
                </h3>
                <p className="text-sm text-muted-foreground font-bold mt-2 capitalize">
          ...
          <div className="p-8 md:p-12">
            <div className="flex items-center gap-3 text-muted-foreground">
              <ArrowLeft className="size-5" />
              <span className="text-sm font-bold tracking-wide uppercase">No Previous Project</span>
            </div>
          </div>
        )}
      </div>
        ...
        {next ? (
          ...
          >
            ...
            >
              <div className="flex items-center justify-end gap-3 text-muted-foreground group-hover:text-foreground transition-colors">
                <span className="text-sm font-bold tracking-wide uppercase">Next Project</span>
          ...
          <div className="p-8 md:p-12 text-right">
            <div className="flex items-center justify-end gap-3 text-muted-foreground">
              <span className="text-sm font-bold tracking-wide uppercase">No Next Project</span>
              <ArrowRight className="size-5" />
            </div>
          </div>
        )}
