...
const contactFormSchema = z.object({
  ...
  projectType: z.enum(['web', 'uiux', 'collaboration'], {
  ...
  if (isSuccess) {
    return (
      ...
      >
        ...
        <h3 className="text-2xl font-bold tracking-wide">Message Sent!</h3>
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-sm font-bold tracking-wide">
                Name
              </FormLabel>
              <FormControl>
                <Input
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent className="bg-popover z-50">
                  <SelectItem value="web" className="font-bold">
                    Web / Frontend Project
                  </SelectItem>
                  <SelectItem value="uiux" className="font-bold">
                    UI/UX Design
                  </SelectItem>
                  <SelectItem value="collaboration" className="font-bold">
                    Collaboration / Other
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  ...
                  className="min-h-32 font-bold resize-none"
                  {...field}
                />
              </FormControl>
              <FormMessage className="text-xs font-bold" />
