    ...
    <>
      ...
      <main className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-6">
        ...
        >
          ...
          >
            <h1 className="text-[120px] md:text-[180px] font-bold tracking-wider leading-none text-foreground/10">
              404
            </h1>
          </motion.div>
          ...
          <div className="space-y-4 -mt-8">
            ...
            <motion.p
              className="text-base md:text-lg text-muted-foreground font-bold leading-relaxed max-w-md mx-auto"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Button
              asChild
              size="lg"
              className="px-8 py-6 text-base font-bold tracking-wide group"
            >
              <Link to="/">
